...
class SimilarQuestion(ModelItem):
    __model__ = models.SimilarQuestion
...
class Hint(ModelItem):
    __model__ = models.Hint


class Solution(ModelItem):
    __model__ = models.Solution
